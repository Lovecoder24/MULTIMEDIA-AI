...
A web application that generates text, images, audio, and video using various AI APIs.

## Features
- Text generation using Replicate (Llama 2)
...
## Deployment
This application is deployed on github. You can access it at: 
